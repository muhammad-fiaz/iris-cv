...
Welcome to **Observers**! This library provides high-performance computer vision algorithms, image manipulation tools, and deep learning model hosting fully in safe Rust.
...
**Observers** solves these issues by writing all algorithms natively in Rust:
